...
import com.example.busschedule.viewmodels.BusScheduleVieModelFactory
...
class StopScheduleFragment: Fragment() {
    ...
    private val viewModel:BusScheduleViewModel by activityViewModels{
        BusScheduleVieModelFactory((activity?.application as BusScheduleApplication).database.scheduleDao())
    }
